module ReservationTokensHelper
  ...
  def write_token_log_entry(oper, tkn)
    ...
    @theevent = oper + "Tapahtumaaika: "+ DateTime.now.to_s + ", Type: " + token_type_to_s(tkn.tokenType) + ", Käyttäjä: " + current_user.name + ", Kohde: " + $target.name  + ", Käyttöpäivä: " + tkn.useDay.to_s
